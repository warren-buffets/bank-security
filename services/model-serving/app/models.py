    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "context": {"ip": "1.2.3.4", "geo": "FR", "device_id": "d123", "channel": "app"}
            }
        }
